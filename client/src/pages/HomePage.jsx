  ...
  return (
    <div className="flex items-center justify-center h-[100vh] sm:w-full bg-gradient-to-tr from-red-600 via-red-400 to-pink-300">
      ...
      <h1 className=" text-black text-center px-4 py-2 sm:text-7xl text-6xl rubik-moonrocks-regular">
        ...
        <h2 className=" font-bold mb-4 font-serif sm:text-6xl text-4xl rubik-mono-one-regular">2024</h2>
        ...
        <div className=" w-64 sm:w-96 sm:place-content-between flex text-center text-base sm:text-lg sm:pt-10  pt-5 text-base">
          <div>
        ...
        <div className=" bg-white w-80 h-24">
